...
#import "Power3ViewController.h"

@interface Power3ViewController ()

@end

@implementation Power3ViewController
@synthesize dimView;
...
- (void)viewDidLoad
{
    ...
    self.popupButtons = [NSArray arrayWithObjects:self.popupButton1, self.popupButton2, self.footnoteButton, nil];
    ...
    UIGestureRecognizer *tapGestureRecognizer2 = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(closePopup2:)];
    [self.popupView2 addGestureRecognizer:tapGestureRecognizer2];
    
    UIGestureRecognizer *tapGestureRecognizer3 = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(closeFootnote:)];
    [self.footnoteView addGestureRecognizer:tapGestureRecognizer3];
}
