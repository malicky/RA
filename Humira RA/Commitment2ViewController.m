...
@interface Commitment2ViewController ()

@end

@implementation Commitment2ViewController
...
{
    self = [super initWithNibName:@"Commitment2ViewController" bundle:nibBundleOrNil];
    if (self) {
